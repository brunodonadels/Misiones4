var size = 0;
var placement = 'point';
function categories_Capacitaciones2018_22(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Concientizacion':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 5.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1}), fill: new ol.style.Fill({color: 'rgba(255,1,5,1.0)'})}),
...
var style_Capacitaciones2018_22 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_Capacitaciones2018_22(feature, value, size, resolution, labelText,
